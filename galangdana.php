...
<body>
    ...
    <div class="container-fluid">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-active"><a href="galangdana.php">Mulai Galang Dana</a></li>
          <li class="dropdown">
  ...
  <div class="container">
    ...
    <!-- Page Heading -->
    <h1 class="my-4"><center>Mulai Galang Dana</center>
    </h1>
    ...
    <div class="row">
      ...
      <form action="controllers/GalangdanaController.php" method="post" class="col-md-7" enctype="multipart/form-data">
        <div class="form-group">
          <label for="judul">Judul Galang Dana</label>
          <input type="text" class="form-control" name="judul" id="judul" placeholder="Contoh: Bantuan untuk Korban Gempa" maxlength="50">
        </div>
        <div class="form-group">
          <label for="target">Target Donasi</label>
          <input type="text" class="form-control" id="target" name="target" placeholder="Minimal Rp 1.000.000">

        </div>
        <div class="form-group">
          <label for="expired">Tenggat Waktu Acara</label>
          <input type="date" class="form-control" name="expired" id="expired" placeholder="Tanggal">
        </div>
        <div class="form-group">
          <label for="foto">Foto Donasi</label>
          <input type="file" class="form-control" name="foto" id="foto">
        </div>
        <div class="form-group">
          <label for="deskripsi">Deskripsi Donasi</label>
          <textarea class="form-control" name="deskripsi" id="deskripsi" rows="2" maxlength="500"></textarea>
        </div>
        <center>
          <input type="submit" name="submit" class="btn btn-primary btn-lg btn-buat" value="Buat">
        </center>
      </form>
