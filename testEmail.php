...
$mail->Username = 'team.armi3@gmail.com';          // SMTP username
$mail->Password = 'bismillaharmi'; // SMTP password
$mail->SMTPSecure = 'tls';                         // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                 // TCP port to connect to

$mail->setFrom('team.armi3@gmail.com');
// $mail->addReplyTo('email@suckittrees.com', 'Suckittrees');
$mail->addAddress('mfahmialif00@gmail.com');   // Add a recipient
