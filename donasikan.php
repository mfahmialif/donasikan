...
<body>
  ...
  <div class="container">
    ...
    <!-- Page Heading -->
    <h1 class="my-4"><center>Mulai Donasikan</center>
    </h1>
    ...
    <div class="row">
      ...
      <form action="controllers/DonasikanController.php" method="get" class="col-md-7">
        <div class="form-group">
          ...
          value="<?php echo $_SESSION['judul_donasi']; ?>">
        </div>
        <div class="form-group">
          <label for="nama">Nama Pendonasi</label>
          <input type="text" class="form-control" id="nama" name="nama" placeholder="Contoh: Anonymous">
        </div>
        <div class="form-group">
          <label for="donasikan">Donasikan</label>
          <input type="text" class="form-control" id="donasikan" name="donasikan" placeholder="Contoh: 1000000">
        </div>
        <center>
          <br>
          <input type="submit" name="submit" class="btn btn-primary btn-lg btn-buat" value="Donasikan">
        </center>
      </form>
